  ...
  <body>
                    ...
                    <ul>
                       <li class="d-flex align-items-center">
                          ...
                          <div class="offcanvas__contact-text">
                             <a target="_blank"
                                href="#">Barheta Road Laheriasarai, Darbhanga, Bihar-846001</a>
                          </div>
                       </li>
                       <li class="d-flex align-items-center">
                          <div class="offcanvas__contact-icon mr-15">
     ...
     <main>
        ...
        <div class="bar-wrapper-container p-relative">
           ...
           <div class="breadcrumb__area theme-bg-1 p-relative" data-background="images/page-title-1.jpg">
              <div class="bar-top" data-background="images/top-bar.png"></div>
              <div class="bar-bottom" data-background="images/bottom-bar.png"></div>
              <div class="yellow-shape" data-background="images/shape-12.png"></div>
                 ...
                 <div class="row justify-content-center">
                    <div class="col-xxl-12">
                       <div class="breadcrumb__wrapper p-relative">
                          ...
                          <h2 class="breadcrumb__title">Video</h2>
                       </div>
                    </div>
                 </div>
              </div>
           ...
           <a id="whatsappbtn" href="https://wa.me/+917070521500" target="_blank" style="display: block;"><img src="image/whatsapp.png" alt="Whatsapp" title="Whatsapp"></a>
