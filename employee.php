...
if (isset($_POST['btn_login'])) {
    ...
    if ($row) {
        ...
        // echo "</pre>";
        // exit();
        if ($aadhar_row && !empty($aadhar_row['aadhar_no'])) {
        ...
        <form action="" method="post">
            <div class="login-form">
                <div class="container col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder="Employee ID" name="sponsor_id" required>
                    ...
                    <?php if (isset($errormsg) && $errormsg == 'error') { ?>
                        <div class="alert alert-danger mt-3">Invalid Employee ID or Password</div>
                    <?php } ?>
                                ...
                                <div class="footer-widget-3">
                                    ...
                                    <div class="admin-login mt-3">
                                        <a href="adminlogin.php" title="admin Login - Amitabh Builders & Developers" class="admin-login-link">
                                            <i class="fa fa-user text-white"></i><span class="text-white" style="margin-left: 1rem;">Employee Login</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
