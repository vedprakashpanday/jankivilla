               ...
               <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                  <div class="footer-widget-3">
                     ...
                     <div class="admin-login mt-3">
                        <a href="termcondition.php" title="admin Login - Amitabh Builders & Developers" class="admin-login-link">
                           <i class="fa fa-file-contract text-white"></i>
                           <span class="text-white" style="margin-left: 1rem;">Terms &amp; Conditions</span>
