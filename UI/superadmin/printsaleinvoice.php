    ...
    <?php else: ?>
        <div id="print">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($payment_row['payment_mode'] == 'cheque') {
                                            echo "Cheque: " . ($payment_row['cheque_number'] ?: 'N/A') . ", Bank: " . ($payment_row['bank_name'] ?: 'N/A') . ", " . ($payment_row['cheque_date'] ? date('d-m-Y', strtotime($payment_row['cheque_date'])) : 'N/A');
                                        } elseif ($payment_row['payment_mode'] == 'transfer' || $payment_row['payment_mode'] == 'bank_transfer') {
                                            echo "UTR: " . ($payment_row['utr_number'] ?: 'N/A');
                                        } else {
                                            echo "N/A";
                                        }
                                        ?>
            ...
            <div class="compact-section">
                ...
                <table>
                    <tr>
                        <td>📍 Barheta Road, Laheriasarai, Darbhanga, Bihar-846001</td>
                    </tr>
                    <tr>
                        <td>🌐 <a href="http://www.harihomes.co/">www.harihomes.co</a> | ✉️ <a href="mailto:Harihomes34@gmail.com">Harihomes34@gmail.com</a></td>
                    </tr>
                </table>
            </div>
        </div>
