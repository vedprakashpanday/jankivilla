                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-12">
                                                <div style="background: #fff; padding: 20px; border: 2px solid #fff; box-shadow: 1px 3px 12px 4px #988f8f;">
                                                    <h2>KYC Details</h2>
                                                    <hr>
                                                    <div id="" style="width:90%;overflow:auto;padding:20px">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <table class="col-md-12">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td><b>Upload Address Proof</b></td>
                                                                            <td></td>
                                                                ...
                                                                <table class="col-md-12">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td></td>
                                                                            <td><input name="" type="text" id="" class="form-control"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>&nbsp;</td>
                                                                            <td>&nbsp;</td>
                                                                ...
                                                                <table class="col-md-12">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td><input type="submit" name="" value="Update" id="" class="btn btn-primary text-white fw-bold fs-1 text-uppercase"></td>
                                                                        </tr>
