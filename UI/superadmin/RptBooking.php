...
<body class="hold-transition skin-blue sidebar-mini">
    <form method="post" action="./RptBooking.php" id="form1">
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($bookings as $booking): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $booking['sqfeet']; ?></td>
                                                                        <td><?php echo $booking['product_type'] == 1 ? 'One Time Registry' : 'EMI Mode'; ?></td>
