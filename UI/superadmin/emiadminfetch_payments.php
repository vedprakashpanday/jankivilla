...
if (isset($_POST['invoice_id'])) {
    ...
    $output .= "<div class='table-responsive' style='max-width: 75vw; overflow-x: auto;'>";
    $output .= "<table class='table table-bordered nowrap' style='min-width: 1200px;'>";
    $output .= "<thead>
                    <tr>
                        <th>Invoice ID</th>
                        <th>Customer Name</th>
