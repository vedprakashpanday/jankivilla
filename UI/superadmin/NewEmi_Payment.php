...
<body class="hold-transition skin-blue sidebar-mini">
                                            ...
                                            <div id="resultContainer" class="result-box" style="display: none;">
                                                ...
                                                <table id="customerTable">
                                                    ...
                                                    <tr class="payment-row">
                                                        <th>Payment Date</th>
                                                        <td>
                                                            <input type="date" id="payment_date" class="form-control" style="width: 200px;">
                                                        </td>
                                                    </tr>
                                                    <tr class="payment-row">
                                                        <th>Payment Mode</th>
                                                    ...
                                                    <tr id="chequeDetails" class="payment-details">
                                                    ...
                                                    <tr id="bankTransferDetails" class="payment-details">
                                                        <th>Bank Transfer Details</th>
                                                        <td>
                                                            <input type="text" id="utr_number" class="form-control" placeholder="UTR Number" style="width: 200px;">
                                                        </td>
                                                    </tr>
                                                    <tr>
    ...
    <script>
        ...
        // Clear OTP error when modal is hidden
        ...
        document.getElementById('searchBtn').addEventListener('click', function() {
            const invoiceId = document.getElementById('printinvoice').value;
                ...
                .then(data => {
                    ...
                    if (data.payments && data.payments.length > 0) {
                        data.payments.forEach((payment, index) => {
                            ...
                            <td>${payment.created_date || 'N/A'}</td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger delete-btn" 
                                    data-row-id="${payment.id}"
                                    data-invoice-id="${payment.invoice_id}"
                                    onclick="deletePayment(${payment.id}, '${payment.invoice_id}')">
                                    Delete
                                </button>
                                </div>
                            </td>
                        ...
                        paymentBody.innerHTML = '<tr><td colspan="14">No payment history found</td></tr>';
                    }
        ...
        document.getElementById('submitPayment').addEventListener('click', function() {
            ...
            const chequeDate = document.getElementById('cheque_date').value.trim();
            ...
            if (paymentMode === 'bank_transfer' && !utrNumber) {
                alert('Please provide UTR number for bank transfer');
                return;
            }
            ...
            } else if (paymentMode === 'cheque' && chequeNumber) {
            ...
            fetch('payment_process.php', {
                ...
                .then(data => {
                    if (data.exists) {
                        alert('This cheque number with the same bank already exists for this invoice. Please use a different bank or cheque number.');
                        return;
                    }
