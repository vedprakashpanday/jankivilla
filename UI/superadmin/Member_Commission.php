...
<head id="Head1">
    ...
    <script language="javascript" type="text/javascript">
        function HideShowDiv(Flag1) {

            if (Flag1 == "first") {

                document.getElementById('ContentPlaceHolder1_ShowDiv').style.display = 'none';
                document.getElementById('ContentPlaceHolder1_ShowDiv').style.display = 'block';
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        WHERE created_date BETWEEN :from_date AND :to_date OR created_date IS NULL
        ...
        <tbody>";
                        ...
                        if (!empty($customer_data)) {
                            ...
                            foreach ($customer_data as $row) {
                                ...
                                echo "<td><button type='button' class='btn btn-primary view-payments' data-row-id='$unique_row_id' data-member-id='$member_id'>View</button></td>";
                                ...
                                echo "<td>" . ($row['producttype'] ?: 'N/A') . "</td>";
