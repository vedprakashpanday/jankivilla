...
<body class="hold-transition skin-blue sidebar-mini">
  <form method="post" action="./DeleteInvoice.php" id="form1">
                    ...
                    <div
                      ...
                      <div
                        style="
                          ...
                          ">
                        <div id="ContentPlaceHolder1_ShowDiv" class="d-none">
                          <div class="row">
                            <div class="col-md-4">
                              <span
                                id="ContentPlaceHolder1_Label21"
                                class="lable-field">Enter Plot Name. :
                              </span>
                              <input
                                name="ctl00$ContentPlaceHolder1$txtMemberIDD"
                                type="text"
                                id="ContentPlaceHolder1_txtMemberIDD"
                                class="form-control"
                            ...
                            <div class="col-md-2">
                              ...
                              <input
                                type="submit"
                                name="ctl00$ContentPlaceHolder1$txtmemberid"
                                value="Delete"
                                id="ContentPlaceHolder1_txtmemberid"
                                class="btn btn-danger" />
                            </div>
                          </div>
                          <div
                            id="ContentPlaceHolder1_Panel3"
                            style="
                                width: 100%;
                                overflow: auto;
                                padding-top: 10px;
