...
foreach ($level7_members as $level7_member) {
    $level8_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.sponsor_id, r.mem_sid, p.package, r.date_time, p.status  FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id WHERE r.sponsor_id = :member_id");
...
<body class="hold-transition skin-blue sidebar-mini">
    <form method="post" action="./Label_04admin.php" id="form1">
                    ...
                    <div class="main-panel">
                        <div class="content-wrapper" style="background:unset!important;">
                            ...
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading" style="margin:1rem;">Assistant General Manager (A.G.M.)</h2>
                                </header>
                            </div>
                                    ...
                                    <table id='salesTable' class="table table-striped">
                                        ...
                                        <thead>
                                         ...
                                         <tbody>
                                          ...
                                          $designation = 'Assistant General Manager (A.G.M.)';
