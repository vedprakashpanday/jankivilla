...
if (isset($_POST['btnsubmit'])) {
    ...
    $mem_email      = trim($_POST['mem_email'])??null;
    ...
    // 1️⃣ Check if designation already exists
$checkStmt = $pdo->prepare("SELECT id FROM adm_desig WHERE designation = ?");
$checkStmt->execute([$designation]);
                                        ...
                                        <div class="col-md-12">
                                            <form method="post" action="" id="form1" enctype="multipart/form-data">
                                                <div style="background:#fff;padding:30px;border:2px solid #fff;box-shadow:1px 3px 12px 4px #988f8f;">
                                                    <h2>Add New Administrative Member</h2>
                                                    <hr>
                                                    ...
                                                    <div class="row mt-3">
                                                      ...
                                                      <div class="col-md-4">
                                                        ...
                                                        <datalist id="designationList">
                                                              <?php 
                                                                    $stmt = $pdo->prepare("SELECT * FROM adm_desig");
                                                                $stmt->execute();
