...
foreach ($level4_members as $level4_member) {
    $level5_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.sponsor_id, r.mem_sid, p.package, r.date_time, p.status  FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id WHERE r.sponsor_id = :member_id");
                ...
                <div class="main-panel">
                    <div class="content-wrapper" style="background:unset!important;">
                        ...
                        <div class="sec-box">
                            ...
                            <header>
                                <h2 class="heading" style="margin:1rem;">Assistant Marketing Manager (A.M.M.)</h2>
                            </header>
                        </div>
                                ...
                                <table id='salesTable' class="table table-striped">
                                    <thead>
                                      ...
                                      <tbody>
                                          ...
                                          $designation = 'Assistant Marketing Manager (A.M.M.)';
...
$i=0;
                            ...
                            <!-- <p style="text-align:right"><b>Total Earning :</b> <span id="">20</span></p> -->
