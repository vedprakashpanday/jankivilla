...
$level1_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.mem_sid, p.package, p.date_time FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id  WHERE r.sponsor_id = :sponsor_id");
$level1_stmt->bindParam(':sponsor_id', $sponsor_id);
$level1_stmt->execute();
$level1_members = $level1_stmt->fetchAll(PDO::FETCH_ASSOC);
foreach ($level1_members as $member) {
...
foreach ($level1_members as $level1_member) {
    $level2_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.sponsor_id, r.mem_sid, p.package, r.date_time, p.status  FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id WHERE r.sponsor_id = :member_id");
...
foreach ($level2_members as $member) {
    // echo $member['s_name'] . $member['sponsor_id'] . "<br>";
}
?>
                ...
                <div class="main-panel">
                    <div class="content-wrapper" style="background:unset!important;">
                        ...
                        <div class="sec-box">
                            ...
                            <header>
                                <h2 class="heading" style="margin:1rem;">Senior Sales Executive (S.S.E.)</h2>
                            </header>
                        </div>
                            ...
                            <div id="" style="overflow:auto;width:100%">
                                ...
                                <table id="salesTable" class="table table-striped">
                                   ...
                                   <tbody>
                                          ...
                                          $designation = 'Senior Sales Executive (S.S.E.)';
