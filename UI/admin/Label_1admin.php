...
foreach ($level9_members as $level9_member) {
    $level10_stmt = $pdo->prepare("SELECT * FROM tbl_regist WHERE sponsor_id = :member_id");
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper" style="background:unset!important;">
                        ...
                        <div class="sec-box">
                            <header>
                                <h2 class="heading" style="margin:1rem;">Sales Executive (S.E.)</h2>
                            </header>
                        </div>

                        <div class="col-md-12" style="padding:30px 12px;">
