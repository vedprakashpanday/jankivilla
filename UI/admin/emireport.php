...
$query = "
    SELECT DISTINCT esr.invoice_id, esr.member_id, tr.m_name, esr.customer_name, esr.customer_mobile, esr.productname, 
           esr.net_amount, esr.payamount, esr.due_amount, esr.emi_month
    FROM emi_schedule_records esr
    LEFT JOIN tbl_regist tr ON esr.member_id = tr.mem_sid where esr.emi_month IS NOT NULL
...
<head id="Head1">
    ...
    <title>
        Amitabh Builders & Developers Pvt. Ltd. - EMI Report
    </title>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if (!empty($customer_data)) {
                                                                        ...
                                                                        foreach ($customer_data as $row) {
                                                                            ...
                                                                            $member_name = htmlspecialchars($row['m_name'] ?? 'Unknown');
                                                                            ...
                                                                            echo "<td>" . htmlspecialchars($row['customer_mobile'] ?? 'N/A') . "</td>";
