                                                    ...
                                                    <div id="" style="overflow:auto;width: 94%">
                                                        ...
                                                        $query = "
                                                         SELECT 
                                                            ...
                                                            AND (c.created_date BETWEEN :from_date AND :to_date OR c.created_date IS NULL)
                                                        ...
                                                        echo "<div class='table-responsive' style='overflow-x: scroll; height:600px;'>";
                                                        ...
                                                        <script>
                                                            $(document).ready(function() {
                                                                $('.view-payments').on('click', function() {
                                                                    ...
                                                                    $.ajax({
                                                                        url: 'emiadminfetch_payments.php',
                                                                        method: 'POST',
                                                                        data: {
