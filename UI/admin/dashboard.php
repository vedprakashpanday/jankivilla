...
<body class="hold-transition skin-blue sidebar-mini ">
    <form method="post" action="" id="form1" style="margin: unset;">
        ...
        <div class="wrapper">
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="main-panel">
                        ...
                        <div class="" style="background: #fff; padding: 10px; border: 2px solid #fff; box-shadow: 1px 3px 12px 4px #988f8f; width: 100%;">
                            <p style="color: black; font-size: 20px; font-family: 'Arial Rounded MT'; text-align: center">ADMIN DASHBOARD</p>
                        </div>
                        <div class="container" style="padding-top: 50px; padding-bottom: 50px;">
                            <a href="javascript:void(0);" id="viewDashboardLink" style="text-decoration: none;color:black; font-weight:500; font-size:large;">View Dashboard</a>
                            <div class="row mb-4" id="hidemydashboard" style="display: none;">
                                <div class="col-md-6">
                                    ...
                                    <div class="details-section">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 detail-item">
                                                <p style="color: #222; margin-top: 10px">
                                                    <b>User Name : </b>
                                                    <span id="ContentPlaceHolder1_lblname" style="margin-left: 10px">Amitabh Kumar(admin)</span>
                                                </p>
                                            </div>
                                            <div class="col-md-6 detail-item">
                                                <p style="color: #222; margin-top: 10px">
                                                    <b>User Id : </b>
                                                    <span id="ContentPlaceHolder1_lbluserid" style="margin-left: 10px">JV000001</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 detail-item">
                                                ...
                                                <span id="ContentPlaceHolder1_lblregdate" style="margin-left: 10px">04/10/2025 05:07:10 PM</span>

                                            </div>
                                            <div class="col-md-6 detail-item">

                                                <b>Mobile No : </b>
                                                <span id="ContentPlaceHolder1_lblmob" style="margin-left: 10px">9031079721</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 detail-item">
                                                ...
                                                <b>Email : </b>
                                                <span id="ContentPlaceHolder1_lblmailid" style="margin-left: 10px">abdeveloperspl@gmail.com</span>

                                            </div>
                                            <div class="col-md-6 detail-item">

                                                <b>Address : </b>
                                                <span id="ContentPlaceHolder1_lblAddress" style="margin-left: 10px">Darbhanga, Bihar</span>
                                            </div>
                                        </div>
            ...
            <script>
                // Get the link and the div containing the dashboard
                const viewDashboardLink = document.getElementById('viewDashboardLink');
                const dashboardDiv = document.getElementById('hidemydashboard');

                // Add an event listener to the link
                viewDashboardLink.addEventListener('click', function() {
                    // Toggle the visibility of the dashboard div
                    if (dashboardDiv.style.display === 'none') {
                        dashboardDiv.style.display = '';
                        viewDashboardLink.innerText = 'Hide Dashboard'; // Change link text
                    } else {
                        dashboardDiv.style.display = 'none';
                        viewDashboardLink.innerText = 'View Dashboard'; // Change link text
                    }
                });
            </script>