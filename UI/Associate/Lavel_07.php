...
foreach ($level6_members as $level6_member) {
    $level7_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.sponsor_id, r.mem_sid, p.package, r.date_time, p.status  FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id WHERE r.sponsor_id = :member_id");
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="main-panel ">
                        ...
                        <div class="col-md-12" style="">
                            <h2 class="heading" style="padding-top:40px"> Level 7 Income</h2>
