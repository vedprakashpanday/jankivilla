...
<head>
    ...
    <title>
        Amitabh Builders & Developers | Team Purchase Plot Commission
    </title>
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel p-1">
                    <h3 class="p-4">Team Purchase Plot Commission</h3>
                    <div id="" style="overflow:auto;width: 100%">
                        ...
                        {
                            $query = "SELECT mem_sid, m_name FROM tbl_regist WHERE sponsor_id = :sponsor_id";
...
";
                        ...
                        <tr>
                            <th>View</th>
                            <th>Team</th> <!-- Add Commission column -->
                    ...
                    <tbody>";
                        ...
                        foreach ($customer_data as $row) {
                            ...
                            echo "<td><a href='viewcommission.php?invoice_id=$invoice_id&member_id=$member_id' class='btn btn-info'>Team</a></td>"; // Add Commission button
