...
<body data-new-gr-c-s-check-loaded="14.1223.0" data-gr-ext-installed="">
    <form method="post" action="./Level_1.php" id="form1">
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="main-panel ">
                        ...
                        <div class="col-md-12" style="">
                            <h2 class="heading" style="padding-top:40px"> Level 10 Income</h2>
                        ...
                        ");
                            ...
                            <p style="text-align:right"><b>Total Earning :</b> <span id=""></span></p>
