                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="action-buttons">
                                                    <div class="btn-group">
                                                        <a href="selfmembers_report.php?from=<?php echo $period['from_date']; ?>&to=<?php echo $period['to_date']; ?>&zero=with_zero"
                                                            class="btn btn-m btn-primary view-members"
                                                            data-base-url="selfmembers_report.php?from=<?php echo $period['from_date']; ?>&to=<?php echo $period['to_date']; ?>&zero=">
                                                            View Members
                                                        </a>
