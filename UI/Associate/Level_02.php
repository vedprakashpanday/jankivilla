...
$level1_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.mem_sid, p.package, r.date_time FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id  WHERE r.sponsor_id = :sponsor_id");
            ...
            <div class="container-scroller">
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="main-panel ">
                        ...
                        <div class="col-md-12">
                            <h2 class="heading" style="padding-top:40px"> Level 2 Income</h2>
