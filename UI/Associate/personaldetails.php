...
if (isset($_POST['update'])) {
    ...
    // Update query
    $updateQuery = $pdo->prepare("UPDATE tbl_regist 
        SET m_email = :email, 
            address = :address, 
            district_name = :district, 
            state_name = :state 
        WHERE mem_sid = :memberid");
                        ...
                        <div class="content">
                            ...
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="padding: 20px">
                                        District<br>
                                        <input name="district_name" type="text" value="<?php echo htmlspecialchars($fetchmember['district_name']); ?>" class="form-control">
                                    </div>
                                    <div class="col-md-4" style="padding: 20px">
                                        State<br>
                                        <input name="state_name" type="text" value="<?php echo htmlspecialchars($fetchmember['state_name']); ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
