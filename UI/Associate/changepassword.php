...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password !== $confirm_password) {
        ...
        try {
            // Prepare and execute the SQL query to update the password in tbl_regist (for mem_sid)
            $sql_regist = "UPDATE tbl_regist SET m_password = :new_password WHERE mem_sid = :sponsor_id";
            $stmt_regist = $pdo->prepare($sql_regist);
            $stmt_regist->bindParam(':new_password', $new_password);
            $stmt_regist->bindParam(':sponsor_id', $sponsor_id);

            // Execute the query for tbl_regist
            if (!$stmt_regist->execute()) {
                throw new Exception("Error updating password in tbl_regist.");
            }

            // Prepare and execute the SQL query to update the password in tbl_hire (for sponsor_id)
            $sql_hire = "UPDATE tbl_hire SET sponsor_pass = :new_password WHERE sponsor_id = :sponsor_id";
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <script type="text/javascript">
        //<![CDATA[
        var Page_Validators = new Array(document.getElementById("ContentPlaceHolder1_RequiredFieldValidator1"), document.getElementById("ContentPlaceHolder1_RequiredFieldValidator2"), document.getElementById("ContentPlaceHolder1_RequiredFieldValidator3"), document.getElementById("ContentPlaceHolder1_CompareValidator1"));
        //]]>
    </script>
    ...
    <script type="text/javascript">
        ...
        ContentPlaceHolder1_RequiredFieldValidator1.controltovalidate = "ContentPlaceHolder1_txtOldPswd";
        ContentPlaceHolder1_RequiredFieldValidator1.errormessage = "Required";
        ContentPlaceHolder1_RequiredFieldValidator1.validationGroup = "cngpswd";
        ContentPlaceHolder1_RequiredFieldValidator1.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
        ContentPlaceHolder1_RequiredFieldValidator1.initialvalue = "";
        var ContentPlaceHolder1_RequiredFieldValidator2 = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidator2"] : document.getElementById("ContentPlaceHolder1_RequiredFieldValidator2");
        ContentPlaceHolder1_RequiredFieldValidator2.controltovalidate = "ContentPlaceHolder1_txtNewPswd";
        ContentPlaceHolder1_RequiredFieldValidator2.errormessage = "Required";
        ContentPlaceHolder1_RequiredFieldValidator2.validationGroup = "cngpswd";
        ContentPlaceHolder1_RequiredFieldValidator2.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
        ContentPlaceHolder1_RequiredFieldValidator2.initialvalue = "";
        var ContentPlaceHolder1_RequiredFieldValidator3 = document.all ? document.all["ContentPlaceHolder1_RequiredFieldValidator3"] : document.getElementById("ContentPlaceHolder1_RequiredFieldValidator3");
        ContentPlaceHolder1_RequiredFieldValidator3.controltovalidate = "ContentPlaceHolder1_txtCnfrmPswd";
        ContentPlaceHolder1_RequiredFieldValidator3.errormessage = "Required";
        ContentPlaceHolder1_RequiredFieldValidator3.validationGroup = "cngpswd";
        ...
        ContentPlaceHolder1_CompareValidator1.controltovalidate = "ContentPlaceHolder1_txtCnfrmPswd";
        ContentPlaceHolder1_CompareValidator1.errormessage = "Password Missmatch. Please Confirm Again.";
        ContentPlaceHolder1_CompareValidator1.validationGroup = "cngpswd";
        ContentPlaceHolder1_CompareValidator1.evaluationfunction = "CompareValidatorEvaluateIsValid";
        ContentPlaceHolder1_CompareValidator1.controltocompare = "ContentPlaceHolder1_txtNewPswd";
        ContentPlaceHolder1_CompareValidator1.controlhookup = "ContentPlaceHolder1_txtNewPswd";
        //]]>
    </script>
