...
$level1_stmt = $pdo->prepare("SELECT r.m_name, r.mem_sid, p.package, r.date_time FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id  WHERE r.sponsor_id = :sponsor_id");
...
foreach ($level2_members as $level2_member) {
    $level3_stmt = $pdo->prepare("SELECT r.s_name, r.m_name, r.sponsor_id, r.mem_sid, p.package, r.date_time, p.status  FROM tbl_regist r LEFT JOIN tbl_package p ON r.mem_sid = p.member_id WHERE r.sponsor_id = :member_id");
...
foreach ($level3_members as $member) {
    // echo $member['m_name'] . $member['package'] . $member['date_time'] . $member['mem_sid'] . $member['status'] . "<br>";
}
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="main-panel ">
                        ...
                        <div class="col-md-12" style="margin-bottom: -9rem;">
                            <h2 class="heading" style="padding-top:40px"> Level 3 Income</h2>
