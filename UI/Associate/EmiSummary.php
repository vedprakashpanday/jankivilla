...
<body>
    ...
    <div class="wrapper">
        <div class="container-scroller">
                ...
                <div class="main-panel" style="padding: 5px">
                    ...
                    <div style="background: #fff; padding: 20px; border: 2px solid #fff; box-shadow: 1px 3px 12px 4px #988f8f;">
                        ...
                        <div class="table-section">
                            <h3 style="padding-top: 30px;">EMI Registry Dues / Payment</h3>
                            <hr>
            ...
            AND pt.product_type_name = 'EMI Mode'
        ...
        <tbody>";
                                ...
                                if (empty($customer_data)) {
                                    echo "<tr>
                <td colspan='12'>No records found for member ID: $logged_in_member_id or their downlines with 'EMI Mode'</td>
            </tr>";
                                }
            ...
            " . ($selectedMonth ?
                                    ...
                                    " (showing all dates)") . "
            <br>Filtered for Product Type: <strong>EMI Mode</strong>
        </div>";
                                ?>
                            </div>
                        </div>
