   ...
   <div>
      ...
      <div class="bar-wrapper-container p-relative">
         ...
         <section class="contact-info-section section-space">
            <div class="container">
               <div class="row g-4">
                  <div class="col-xxl-3 col-xl-3 col-lg-36 col-md-6 h-auto">
                     <div class="contact-info-box ">
                        <div class="icon">
                           <i class="fal fa-location-dot"></i>
                        </div>
                        <h5 class="mt-15 mb-15 ">Head Office</h5>
                        <a href="#" class="text-dark">1st Floor, Pappu Yadav Building, South of NH-27, Kakarghati Chowk,
            Bhuskaul, Darbhanga-846007</a>
                     </div>
                  </div>
                  <div class="col-xxl-3 col-xl-3 col-lg-36 col-md-6 h-auto">
                     <div class="contact-info-box ">
                        ...
                        <h5 class="mt-15 mb-15 ">Branch Office</h5>
                        <a href="#" class="text-dark"> Near Jha Indian Petrol Pump, Mohana Chowk,
            Jhanjharpur, Madhubani, Pin-847404 (Bihar)</a>
                     </div>
                  </div>
                  <div class="col-xxl-3 col-xl-36 col-lg-3 col-md-6">
                     <div class="contact-info-box">
                        <div class="icon">
                           <i class="far fa-envelope"></i>
                        </div>
                        <h5 class="mt-15 mb-15">Email Id</h5>
                        <a href="mailto:abdeveloperspl@gmail.com" class="text-dark" title="Email id - Amitabh Builders & Developerss.">abdeveloperspl@gmail.com</a>
                     </div>
                  </div>
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                     <div class="contact-info-box">
                        ...
                        <a href="tel:+919472467007" title="" class="text-dark">9472467007</a>
                        <a href="#" title="" class="text-dark">9060218/222/333/666</a>
                     </div>
                  </div>
